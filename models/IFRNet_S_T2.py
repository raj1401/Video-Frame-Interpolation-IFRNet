...
# WHAT'S DIFFERENT
# Less number of channels in the decoder and encoder
...
class Decoder4(nn.Module):
    def __init__(self):
        ...
        self.convblock = nn.Sequential(
            convrelu(108+1, 108), 
            ResBlock(108, 24), 
            nn.ConvTranspose2d(108, 40, 4, 2, 1, bias=True)
        )
...
class Decoder3(nn.Module):
    def __init__(self):
        ...
        self.convblock = nn.Sequential(
            convrelu(112, 80), 
            ResBlock(80, 24), 
            nn.ConvTranspose2d(80, 28, 4, 2, 1, bias=True)
        )
...
class Decoder2(nn.Module):
    def __init__(self):
        ...
        self.convblock = nn.Sequential(
            convrelu(76, 84), 
            ResBlock(84, 24), 
            nn.ConvTranspose2d(84, 20, 4, 2, 1, bias=True)
        )
...
class Decoder1(nn.Module):
    def __init__(self):
        ...
        self.convblock = nn.Sequential(
            convrelu(52, 44), 
            ResBlock(44, 24), 
            nn.ConvTranspose2d(44, 8, 4, 2, 1, bias=True)
        )
